    ...
    public static String GetMatrix(String term)
{
   ...
   Dbconn db = new Dbconn();
            ...
            ResultSet rs = (ResultSet) st.executeQuery("select * from hybridtrainmatrix where term ='"+ term +"'");
          while (rs.next()) {
...
//**************** For NLP *****************************************
 ...
 //**************************************************
        ...
        // lbl=aspect;
         ...
         if(ValMax ==0.0) {lbl="";flg=1;}
       else if(ValMax==Aweight && flg !=1) {lbl="ambiance"; flg=1;}
         else if(ValMax==fweight && flg!=1 ) {lbl=checkflag(id, con);flg=1;}    
         else  if(ValMax==Pweight && flg!=1) {lbl="price"; flg=1;}
         else if(ValMax==Sweight && flg!=1) {lbl="anecdotes/miscellaneous";flg=1;}
