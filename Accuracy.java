...
import static SentimentProcess.ProcessComments.methodname;
import static SentimentProcess.publicparams.*;
...
public class Accuracy extends ApplicationFrame 
{
    ...
    public Accuracy(final String title) throws IOException, Exception 
    {
        super(title);
